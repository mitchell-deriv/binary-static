    ...
    <div className='authentication'>
        ...
        <div id='idv-container' className='idv-main-container'>
            <div id='idv_country_selector' className='idv-container country-selector invisible'>
                ...
                <select className='idv-container__dropdown' type='select' id='country_dropdown' />
                <Button
            ...
            <div id='idv_document_submit' className='idv-container invisible'>
                ...
                <div className='idv-container__document-container'>
                    <div className='idv-container__left'>
                        <fieldset>
                            <select className='idv-container__dropdown' type='select' id='document_type' />
                        </fieldset>
                        <fieldset>
                            <input
                                id='document_number'
                    ...
                    <div id='idv_document_sample_image' className='idv-container__right invisible' />
                </div>

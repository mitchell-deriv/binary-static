        ...
        <ol className='reset_ol'>
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('The Affiliate shall not impersonate the Company’s domains or purchase or register keywords, search terms, or other identifiers for use in any search engine, portal, sponsored advertising service, or other search or referral service that are identical or similar to any of the Company\'s trademarks or trade names that include the word "[_1]" or any variation thereof.', it.website_name) },
